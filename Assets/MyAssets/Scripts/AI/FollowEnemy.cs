...
{
    [SerializeField] private TransformSceneReference PlayerSceneReference;
    [SerializeField] private Seeker Seeker;
    [SerializeField] private LayerMask GroundMask;
    [SerializeField] private LayerMask EnemyMask;
    [SerializeField] private float PathRequestDelay;
    ...
    {
        Seeker.StartPath (transform.position, PlayerSceneReference.Value.position, OnPathComplete);
    ...
    public void OnPathComplete (Path p) {
        ...
        if (p.error) {
            ...
            //var remainingDelay = PathRequestDelay - (Time.time - lastRequestTime);
            //remainingDelay = Mathf.Max(0f, remainingDelay);

            // Wait before requesting new path
            //LeanTween.value(0f, 1f, remainingDelay)
            //    .setOnComplete(RequestPath);
        }
    }
