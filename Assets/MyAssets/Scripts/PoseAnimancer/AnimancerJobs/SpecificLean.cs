...
namespace MyAssets.Scripts.PoseAnimancer.AnimancerJobs
{
    ...
    /// 
    public sealed class SpecificLean : AnimancerJob<SpecificLean.Job>, IDisposable
    {
        /************************************************************************************************************************/
        #region Initialisation
        /************************************************************************************************************************/

        public SpecificLean(AnimancerPlayable animancer, Vector3 axis, NativeArray<TransformStreamHandle> leanBones)
        {
        ...
        public SpecificLean(AnimancerPlayable animancer)
            : this(animancer, Vector3.forward, GetDefaultHumanoidLeanBones(animancer.Component.Animator))
        { }
        
        /************************************************************************************************************************/

        public SpecificLean(AnimancerPlayable animancer, IEnumerable<Transform> leanBones)
