...
Shader "Meat Object"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 temp_output_83_0_g4 = float4( UnpackScaleNormal( SAMPLE_TEXTURE2D( _Normal, sampler_Normal, uv_Normal ), _NormalScale ) , 0.0 );
			...
			Unity_GlossyEnvironmentData g78_g4 = UnityGlossyEnvironmentSetup( _Smoothness, data.worldViewDir, indirectNormal78_g4, float3(0,0,0));
			...
			float clampResult66_g4 = clamp( fresnelNode65_g4 , 0.0 , 1.0 );
			float4 lerpResult69_g4 = lerp( ( float4( ( ( max( dotResult52_g4 , 0.0 ) * ( ase_lightAtten * ase_lightColor.rgb ) ) + indirectDiffuse77_g4 ) , 0.0 ) * _Color0 ) , float4( indirectSpecular78_g4 , 0.0 ) , clampResult66_g4);
			c.rgb = lerpResult69_g4.rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18400
0;73;1642;1286;-303.1868;1031.16;1.008191;True;True
Node;AmplifyShaderEditor.RangedFloatNode;27;640.4073,-765.6101;Inherit;False;Property;_NormalScale;Normal Scale;7;0;Create;True;0;0;False;0;False;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;24;1025.705,-509.009;Inherit;False;Property;_Color0;Color 0;5;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;23;1024.935,-253.8036;Inherit;False;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;26;1026.29,-766.9152;Inherit;True;Property;_Normal;Normal;6;0;Create;True;0;0;False;0;False;-1;a2fca8d02e7b01e46b82e9cf3ea1ed7c;a2fca8d02e7b01e46b82e9cf3ea1ed7c;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;38;1410.109,-512.0623;Inherit;False;Meat Lighting;1;;4;73b54e17a4cbe7f4eb8f5dc9960b8200;0;4;83;COLOR;1,1,1,0;False;75;COLOR;0,0,0,0;False;79;FLOAT;0;False;80;FLOAT;1;False;1;COLOR;0
...
WireConnection;38;83;26;0
WireConnection;38;75;24;0
WireConnection;38;79;23;0
WireConnection;0;13;38;0
ASEEND*/
//CHKSM=A047166159DEE25AF6FB50E86DC894B91D78794F