...
Shader "Meat Terrain"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float4 temp_output_83_0_g14 = appendResult58;
			...
			#endif //aseld
			float dotResult52_g14 = dot( (WorldNormalVector( i , temp_output_83_0_g14.rgb )) , ase_worldlightDir );
			...
			#endif //aselc
			UnityGI gi77_g14 = gi;
			float3 diffNorm77_g14 = WorldNormalVector( i , temp_output_83_0_g14.rgb );
			gi77_g14 = UnityGI_Base( data, 1, diffNorm77_g14 );
			float3 indirectDiffuse77_g14 = gi77_g14.indirect.diffuse + diffNorm77_g14 * 0.0001;
			...
			float3 indirectNormal78_g14 = WorldNormalVector( i , temp_output_83_0_g14.rgb );
			Unity_GlossyEnvironmentData g78_g14 = UnityGlossyEnvironmentSetup( _Smoothness, data.worldViewDir, indirectNormal78_g14, float3(0,0,0));
			float3 indirectSpecular78_g14 = UnityGI_IndirectSpecular( data, 1.0, indirectNormal78_g14, g78_g14 );
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float3x3 ase_tangentToWorldFast = float3x3(ase_worldTangent.x,ase_worldBitangent.x,ase_worldNormal.x,ase_worldTangent.y,ase_worldBitangent.y,ase_worldNormal.y,ase_worldTangent.z,ase_worldBitangent.z,ase_worldNormal.z);
			float fresnelNdotV65_g14 = dot( mul(ase_tangentToWorldFast,temp_output_83_0_g14.rgb), ase_worldViewDir );
			float fresnelNode65_g14 = ( 0.04 + 1.0 * pow( 1.0 - fresnelNdotV65_g14, 5.0 ) );
			float clampResult66_g14 = clamp( fresnelNode65_g14 , 0.0 , _FresnelMax );
			float4 lerpResult69_g14 = lerp( ( float4( ( ( max( dotResult52_g14 , 0.0 ) * ( ase_lightAtten * ase_lightColor.rgb ) ) + indirectDiffuse77_g14 ) , 0.0 ) * lerpResult37 ) , float4( indirectSpecular78_g14 , 0.0 ) , clampResult66_g14);
			c.rgb = lerpResult69_g14.rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18400
0;73;1642;1286;1509.149;1849.163;1.903285;True;True
...
Node;AmplifyShaderEditor.FunctionNode;38;-253.7324,-1151.767;Inherit;False;Grass;10;;4;a05bb52d51a392d4ea2b48b9e1b3f9fa;0;0;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;39;-479.4717,-1086.951;Inherit;False;Property;_GridColor;Grid Color;9;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;54;-288.1658,-1533.101;Inherit;False;2;2;0;FLOAT3x3;0,0,0,1,0,0,1,0,1;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-477.5638,-800.342;Inherit;False;Property;_Smoothness;Smoothness;15;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;41;-476.1711,-702.4933;Inherit;False;Property;_FresnelMax;Fresnel Max;16;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;56;257.8397,-1023.009;Inherit;False;Meat Lighting;6;;14;73b54e17a4cbe7f4eb8f5dc9960b8200;0;4;83;COLOR;1,1,1,0;False;75;COLOR;0,0,0,0;False;79;FLOAT;0;False;80;FLOAT;1;False;1;COLOR;0
...
WireConnection;56;83;58;0
WireConnection;56;75;37;0
WireConnection;56;79;23;0
WireConnection;56;80;41;0
WireConnection;0;13;56;0
ASEEND*/
//CHKSM=2143100156002244971DFEACC10D365DCF0F8BE5