...
Shader "Odyssey"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 ao24_g1 = ( 1.0 - ( ( 1.0 - SampleGradient( gradient11, UnpackNormal( SAMPLE_TEXTURE2D( _AO2, sampler_AO2, uv_AO2 ) ).x ) ) * _AOFactor2 ) );
			float4 lightAmbient14_g1 = ( _AmbientFactor2 * UNITY_LIGHTMODEL_AMBIENT );
			...
			#endif //aseld
			float dotResult9_g1 = dot( ase_worldNormal , ase_worldlightDir );
			float lightDirectional13_g1 = dotResult9_g1;
			float4 clampResult20_g1 = clamp( ( lightAmbient14_g1 + lightDirectional13_g1 ) , _MinimumAmbient2 , float4( 1,1,1,1 ) );
			float4 lightCombined22_g1 = clampResult20_g1;
			float4 temp_cast_1 = (lightDirectional13_g1).xxxx;
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float fresnelNdotV46_g1 = dot( ase_worldNormal, ase_worldViewDir );
			float fresnelNode46_g1 = ( _Float1 + _Float2 * pow( 1.0 - fresnelNdotV46_g1, _Float3 ) );
			float4 blendOpSrc53_g1 = temp_cast_1;
			float4 blendOpDest53_g1 = ( _RimColor1 * fresnelNode46_g1 );
			float4 lerpBlendMode53_g1 = lerp(blendOpDest53_g1,( blendOpDest53_g1/ max( 1.0 - blendOpSrc53_g1, 0.00001 ) ),_Float4);
			float4 clampResult56_g1 = clamp( ( ( ao24_g1 * ( lightCombined22_g1 * _BaseColor1 ) ) + ( saturate( lerpBlendMode53_g1 )) ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
			o.Albedo = clampResult56_g1.rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18400
0;73;2023;1286;-143.3977;-470.2731;1;True;True
Node;AmplifyShaderEditor.FunctionNode;140;890.397,934.6929;Inherit;False;OdysseyLighting;0;;1;d7276cf1e824d06478e4762dcf51e0c7;0;0;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;68;785.6326,1065.796;Inherit;True;Property;_Normal;Normal;14;0;Create;True;0;0;False;0;False;-1;None;a2fca8d02e7b01e46b82e9cf3ea1ed7c;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=1F92043E5DDB73EA15D06E416BDAB31EE6C14553