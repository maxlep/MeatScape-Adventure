...
namespace JBooth.MicroSplat
{
   ...
   public class StreamManager : MonoBehaviour
   {
      ...
      void OnEnable()
      {
         ...
         if (msObject.keywordSO.IsKeywordEnabled("_MSRENDERLOOP_UNITYLD") ||
            msObject.keywordSO.IsKeywordEnabled("_MSRENDERLOOP_UNITYHD") ||
            msObject.keywordSO.IsKeywordEnabled("_MSRENDERLOOP_UNITYURP2020") ||
            msObject.keywordSO.IsKeywordEnabled("_MSRENDERLOOP_UNITYHDRP2020")
            )
         {
